...
{
    public class ControllerSignupTests
    {
        [Fact]
        public void Signup_OnSuccess_ReturnsSession_WithStatus200()
        {
            // Arrange
        ...
        [Fact]
        public void Signup_OnFailure_ReturnsProblemDetails_WithStatus400()
        {
            // Arrange

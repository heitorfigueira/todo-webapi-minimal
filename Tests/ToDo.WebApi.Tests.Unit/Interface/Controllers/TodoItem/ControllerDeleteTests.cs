...
namespace ToDo.WebApi.Tests.Unit.Interface.Controllers.TodoItem
{
    public class ControllerDeleteTests
    {
        ...
        {
            //Arrange
            var sut = TodoItemControllerSetups.DeleteOnFailureReturnsDeletionFailedError();
        ...
        [Fact]
        public void Delete_OnSuccess_ReturnsTodoItem()
        {
            //Arrange
            var (sut, item) = TodoItemControllerSetups.DeleteOnSuccessReturnsTodoItem();
